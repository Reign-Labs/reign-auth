...
const features = [
	...
	{
		name: "Single Sign-On",
		description: "SSO capabilities with Reign Auth OIDC provider",
	},
];
						...
						<div className="border-y py-2 border-dotted bg-secondary/60 opacity-80">
							<div className="text-xs flex items-center gap-2 justify-center text-muted-foreground">
								<span className="text-center">
									This demo uses Reign Auth as an OIDC provider and implements
					...
					<div className="flex justify-center pt-4">
						{isAuthenticated ? (
							...
							>
								...
								<span>Sign In with Reign Auth</span>
							</Button>
						)}
					</div>
				</div>
