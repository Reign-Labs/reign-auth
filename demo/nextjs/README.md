...
Welcome to the Reign Auth demo app!
...
1. **Clone the repo**:
   ...
   ```bash
   git clone https://github.com/Reign-Labs/reign-auth
   cd reign-auth/demo/nextjs
   ```
...
3. **Set up your environment variables**:
   ...
   * Open `.env` and fill in the required details.
     ...
     connect to the Reign Auth service.
...
* [Reign Auth Documentation](https://auth.reign-labs.com/docs) - Everything you
  need to know to integrate Reign Auth.
...
a pull request on the [GitHub repo](https://github.com/Reign-Labs/reign-auth).

Happy coding!

[email & password]: https://www.auth.reign-labs.com/docs/basic-usage#email-password

[email verification]: https://www.auth.reign-labs.com/docs/concepts/email#email-verification

[multi-factor authentication (mfa)]: https://www.auth.reign-labs.com/docs/plugins/2fa

[organization / teams]: https://www.auth.reign-labs.com/docs/plugins/organization

[passkeys]: https://www.auth.reign-labs.com/docs/plugins/passkey

[password reset]: https://www.auth.reign-labs.com/docs/concepts/email#password-reset-email

[rate limiting]: https://www.auth.reign-labs.com/docs/concepts/rate-limit

[roles & permissions]: https://www.auth.reign-labs.com/docs/plugins/admin#role

[session management]: https://www.auth.reign-labs.com/docs/concepts/session-management

[stripe plugin]: https://www.auth.reign-labs.com/docs/plugins/stripe
