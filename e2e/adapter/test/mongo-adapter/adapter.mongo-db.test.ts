import { mongodbAdapter } from "@reign-auth/mongo-adapter";
import { createTestSuite, testAdapter } from "@reign-auth/test-utils/adapter";
import type { Session, User } from "reign-auth";
...
const { execute } = await testAdapter({
	...
	runMigrations: async (reignAuthOptions) => {},
	tests: [
		normalTestSuite(),
		authFlowTestSuite(),
		transactionsTestSuite(),
