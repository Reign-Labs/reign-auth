# Contributing to Reign Auth

Thank you for your interest in contributing to Reign Auth.
...
The Reign Auth monorepo is organized as follows:

* `/packages/reign-auth` - Core authentication library
...
When contributing to Reign Auth:
...
2. Clone your fork locally:
   ...
   ```bash
   git clone https://github.com/your-username/reign-auth.git
   cd reign-auth
   ```
...
### Core Library (`/packages/reign-auth`)
...
[security@reign-labs.com](mailto:security@reign-labs.com).
