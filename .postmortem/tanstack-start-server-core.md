...
1. [PR #6045](https://github.com/Reign-Labs/reign-auth/pull/6045)
2. [PR #6235](https://github.com/Reign-Labs/reign-auth/pull/6235)
3. [PR #7340](https://github.com/Reign-Labs/reign-auth/pull/7340)
   (v1.4.12 -> v1.4.13)
...
When reign-auth tanstack-start integration imported directly from
this package:
...
* `packages/reign-auth/src/integrations/tanstack-start.ts` -
  Changed import to `@tanstack/react-start/server`
* `packages/reign-auth/src/integrations/tanstack-start-solid.ts` -
  Changed import to `@tanstack/solid-start/server`
* `packages/reign-auth/package.json` -
  Updated peer dependencies from `@tanstack/*-start-server` to
  `@tanstack/*-start`

[gh-issue]: https://github.com/Reign-Labs/reign-auth/issues/7386
