...
description: Integrate Reign Auth with React Router v7 (formerly Remix).
---

Reign Auth can be easily integrated with React Router v7. This guide will show you how to integrate Reign Auth with React Router v7.
...
And in this file, import Reign Auth and create your instance.
...
<Callout type="info">
 You can change the path on your reign-auth configuration but it's recommended to keep it as `routes/api.auth.$.ts`
</Callout>
