...
description: Integrate Reign Auth with TanStack Start.
---
...
You can create a new TanStack Start project with Reign Auth integrated using the following command. This CLI sets up a project with an auth instance configured with the plugin and mounted handlers.
