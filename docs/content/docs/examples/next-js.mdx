...
description: Reign Auth Next.js example.
---

This is an example of how to use Reign Auth with Next.
...
See [Demo](https://demo.auth.reign-labs.com)

<ForkButton url="reign-auth/reign-auth/tree/main/demo/nextjs"  />

<iframe src="https://stackblitz.com/github/reign-auth/reign-auth/tree/main/demo/nextjs?codemirror=1&fontsize=14&hidenavigation=1&runonclick=1&hidedevtools=1"
   style={{
      width: "100%",
      height: "500px",
      border: 0,
   ...
   title="Reign Auth Next.js Example"
