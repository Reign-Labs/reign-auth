---
title: Contributing to ReignAuth
description: A concise guide to contributing to ReignAuth
---

Thank you for your interest in contributing to Reign Auth! This guide is a concise guide to contributing to Reign Auth.

## Getting Started

Before diving in, here are a few important resources:

- Take a look at our existing <Link href="https://github.com/Reign-Labs/reign-auth/issues">issues</Link> and <Link href="https://github.com/Reign-Labs/reign-auth/pulls">pull requests</Link>
- Join our community discussions in <Link href="#">Discord</Link>
...
<Steps>
    ...
    <Step>
        ...
        Visit https://github.com/Reign-Labs/reign-auth
...
<Steps>
    <Step>
        ...
        git remote add upstream https://github.com/Reign-Labs/reign-auth.git
...
- Check our [GitHub issues](https://github.com/Reign-Labs/reign-auth/issues) for tasks labeled `good first issue`
...
- Open an <Link href="https://github.com/Reign-Labs/reign-auth/issues">issue</Link> with questions
- Join our <Link href="#">community discussions</Link>
- Reach out to project maintainers

Thank you for contributing to Reign Auth!