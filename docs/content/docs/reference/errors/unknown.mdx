...
If you believe this error comes from Reign Auth core functionality or a plugin,
please open an issue on [GitHub](https://github.com/Reign-Labs/reign-auth/issues).
