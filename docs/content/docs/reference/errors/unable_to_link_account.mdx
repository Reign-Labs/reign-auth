...
currently authenticated user. Reign Auth blocks the operation if either:
...
* Run pending migrations and ensure the schema matches the current Reign Auth version.
