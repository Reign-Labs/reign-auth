---
title: Comparison
description: Comparison of Reign Auth versus over other auth libraries and services.
---

> <p className="text-orange-400 dark:text-orange-200">Comparison is the thief of joy.</p>

Here are non detailed reasons why you may want to use Reign Auth over other auth libraries and services.
