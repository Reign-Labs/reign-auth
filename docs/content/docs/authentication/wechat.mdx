...
<Steps>
    <Step>
        ...
        To use WeChat sign in, you need to register a website application on the [WeChat Open Platform](https://open.weixin.qq.com/), set the `Authorization Callback Domain` to the Reign Auth domain and get your App ID and App Secret.
    </Step>
