...
description: The `dash()` plugin connects your Reign Auth instance to Reign Auth Infrastructure, enabling analytics tracking, event logging, and admin dashboard APIs.
---
...
export const auth = reignAuth({
  plugins: [
    dash({
      ...
      kvUrl: process.env.REIGN_AUTH_KV_URL,
