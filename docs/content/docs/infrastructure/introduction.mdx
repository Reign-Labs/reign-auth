---
title: Reign Auth Infrastructure
description: Enterprise-grade dashboard, security, and managed services for Reign Auth.
---

Reign Auth Infrastructure is a paid service that extends your authentication system with a management dashboard,
...
import { sentinel } from "@reign-auth/infra";
