---
title: Prisma
description: Integrate Reign Auth with Prisma.
---
...
To use the Prisma adapter, you need to install the `@reign-auth/prisma-adapter` package:

```package-install
@reign-auth/prisma-adapter
```
...
<Callout type="warn">
  ...
  or run our latest CLI version `npx reign-auth@latest generate` to generate a new Prisma schema with the relations.
</Callout>

## Additional Information

- If you're looking for performance improvements or tips, take a look at our guide to <Link href="/docs/guides/optimizing-for-performance">performance optimizations</Link>.
- [How to use Prisma ORM with Reign Auth and Next.js](https://www.prisma.io/docs/guides/betterauth-nextjs)
