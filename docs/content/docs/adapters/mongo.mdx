...
description: Integrate Reign Auth with MongoDB.
---
...
To use the MongoDB adapter, you need to install the `@reign-auth/mongo-adapter` package:

```package-install
@reign-auth/mongo-adapter
```
