...
description: Reign Auth Plugin for Autumn Billing
---
...
<Steps>
  ...
  <Step>
    ...
    ```ts title="auth.ts"
    import { autumn } from "autumn-js/reign-auth";
  ...
  <Step>
      ...
      Client side, wrap your application with the AutumnProvider component, and pass in the `baseUrl` that you define within reign-auth's `authClient`.
      ...
      export default function RootLayout({
        ...
        return (
          <html>
            <body>
              {/* or meta.env.REIGN_AUTH_URL for vite */}
              <AutumnProvider reignAuthUrl={process.env.NEXT_PUBLIC_REIGN_AUTH_URL}>
                {children}
              </AutumnProvider>
            </body>
          </html>
