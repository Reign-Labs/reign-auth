---
title: One Tap
description: One Tap plugin for Reign Auth
---
...
import { oneTap } from "reign-auth/plugins"; // [!code highlight]
...
import { oneTapClient } from "reign-auth/client/plugins"; // [!code highlight]
