---
title: OIDC Provider
description: Open ID Connect plugin for Reign Auth that allows you to have your own OIDC provider.
---
...
<Callout type="warn">
This plugin is in active development and may not be suitable for production use. Please report any issues or bugs on [GitHub](https://github.com/Reign-Labs/reign-auth).
</Callout>
...
<Steps>
    <Step>
        ...
        import { oidcProvider } from "reign-auth/plugins"; // [!code highlight]
    ...
    <Step>
        ...
        import { oidcClient } from "reign-auth/client/plugins" // [!code highlight]
