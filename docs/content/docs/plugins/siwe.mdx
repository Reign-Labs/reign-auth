...
description: Sign in with Ethereum plugin for Reign Auth
---
...
<Steps>
    <Step>
        ...
        import { siwe } from "reign-auth/plugins"; // [!code highlight]
    ...
    <Step>
        ...
        import { siweClient } from "reign-auth/client/plugins"; // [!code highlight]
...
```ts title="auth-client.ts"
import { createAuthClient } from "reign-auth/client";
import { siweClient } from "reign-auth/client/plugins";
...
```ts title="auth.ts"
import { reignAuth } from "reign-auth";
import { siwe } from "reign-auth/plugins";
