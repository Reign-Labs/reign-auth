---
title: Anonymous  
description: Anonymous plugin for Reign Auth.
---
...
<Steps>
  <Step>
    ...
    import { anonymous } from "reign-auth/plugins" // [!code highlight]
  ...
  <Step>
    ...
    import { anonymousClient } from "reign-auth/client/plugins" // [!code highlight]
...
```ts title="auth.ts"
import { reignAuth } from "reign-auth"
import { anonymous } from "reign-auth/plugins"
