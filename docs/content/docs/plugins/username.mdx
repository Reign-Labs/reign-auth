...
<Steps>
    <Step>
        ...
        import { username } from "reign-auth/plugins" // [!code highlight]
    ...
    <Step>
        ...
        import { usernameClient } from "reign-auth/client/plugins" // [!code highlight]
...
By default, the plugin exposes an endpoint `/is-username-available` to check if a username is available. You can disable this endpoint by providing `disabledPaths` option to the reign-auth configuration. This is useful if you want to protect usernames from being enumerated.
