---
title: API Key
description: API Key plugin for Reign Auth.
---
...
<Steps>
    ...
    <Step>
        ...
        import { apiKey } from "@reign-auth/api-key" // [!code highlight]
    ...
    <Step>
        ...
        import { apiKeyClient } from "@reign-auth/api-key/client"  // [!code highlight]
