---
title: Commet
description: Reign Auth Plugin for Billing and Subscriptions using Commet
---
...
```bash
pnpm add reign-auth @commet/reign-auth @commet/node
```
...
import { commetClient } from "@commet/reign-auth";
...
import { commet, portal } from "@commet/reign-auth";
...
```typescript title="Server"
import { commet, subscriptions } from "@commet/reign-auth";
...
```typescript title="Server"
import { commet, features } from "@commet/reign-auth";
...
```typescript title="Server"
import { commet, usage } from "@commet/reign-auth";
...
```typescript title="Server"
import { commet, seats } from "@commet/reign-auth";
...
```typescript title="Server"
import { commet, webhooks } from "@commet/reign-auth";
...
export const authClient = createAuthClient({
  baseURL: process.env.NEXT_PUBLIC_REIGN_AUTH_URL,
  plugins: [commetClient()],
});
