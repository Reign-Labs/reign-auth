---
title: Dodo Payments
description: Reign Auth Plugin for Dodo Payments
---
...
```bash
npm install @dodopayments/reign-auth dodopayments reign-auth zod
```
...
import { dodopaymentsClient } from "@dodopayments/reign-auth";

export const authClient = createAuthClient({
  baseURL: process.env.REIGN_AUTH_URL || "http://localhost:3000",
