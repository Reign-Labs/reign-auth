---
title: Plugins
description: Browse all Reign Auth plugins — authentication, authorization, payments, security, and more.
---

Reign Auth ships with 50+ plugins that extend the framework with additional auth features, payment integrations, security tools, and more.
...
Looking for more? Check out [community plugins](/docs/plugins/community-plugins) built by the Reign Auth community.
