---
title: Admin
description: Admin plugin for Reign Auth
---
...
<Steps>
  <Step>
    ...
    import { admin } from "reign-auth/plugins" // [!code highlight]
  ...
  <Step>
    ...
    import { adminClient } from "reign-auth/client/plugins"  // [!code highlight]
...
<Steps>
   ...
   export const admin = ac.newRole({ // [!code highlight]
    ...
    ```ts title="permissions.ts"
    import { createAccessControl } from "reign-auth/plugins/access";
    import { defaultStatements, adminAc } from "reign-auth/plugins/admin/access";
    ...
    <Step>
        ...
        ```ts title="auth.ts"
        import { reignAuth } from "reign-auth"
        import { admin as adminPlugin } from "reign-auth/plugins"
        ...
        ```ts title="auth-client.ts"
        import { createAuthClient } from "reign-auth/client"
        import { adminClient } from "reign-auth/client/plugins"
