---
title: Dub
description: Reign Auth Plugin for Lead Tracking using Dub links and OAuth Linking
---
...
<Steps>
    ...
    <Step>
        ...
        import { dubAnalytics } from "@dub/reign-auth"
        import { dub } from "dub"
...
import { dubAnalyticsClient } from "@dub/reign-auth/client";
