---
title: Multi Session
description: Learn how to use multi-session plugin in Reign Auth.
---
...
import { multiSession } from "reign-auth/plugins"  // [!code highlight]
...
<Step>
        ...
        import { multiSessionClient } from "reign-auth/client/plugins"  // [!code highlight]
...
```ts title="auth.ts"
import { reignAuth } from "reign-auth"
import { multiSession } from "reign-auth/plugins"
