...
export function getRSS() {
	const feed = new Feed({
		...
		description: "Latest updates, articles, and insights about Reign Auth",
		generator: "reign-auth",
		id: `${baseUrl}blog`,
		link: `${baseUrl}blog`,
		language: "en",
		image: `${baseUrl}release-og/blogs.png`,
		favicon: `${baseUrl}favicon/favicon-32x32.png`,
		copyright: `All rights reserved ${new Date().getFullYear()}, Reign Auth Inc.`,
	});
