...
const roles = [
	{
		...
		description:
			"Craft the visual identity and UI of Reign Auth's products — dashboard, docs, landing pages. You'll own design end-to-end.",
		requirements: [
	...
	},
	{
		...
		location: "San Francisco",
		description:
			"Be the bridge between Reign Auth and its developer community. Create content, speak at events, build demos, and shape the developer experience.",
		requirements: [
		...
		>
			<div className="space-y-6">
				...
				<div className="flex items-center gap-3 pt-1">
					<a
						href="mailto:careers@auth.reign-labs.com"
