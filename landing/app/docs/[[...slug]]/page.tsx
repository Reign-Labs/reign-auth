		...
		>
			<div className="flex items-center justify-between gap-4">
				...
				<div className="flex items-center gap-2 not-prose shrink-0">
					<LLMCopyButton
						rawUrl={`https://raw.githubusercontent.com/Reign-Labs/reign-auth/${gitBranch}/docs/content/docs/${page.path}`}
					/>
					<ViewOptions
						markdownUrl={`${page.url}.mdx`}
						githubUrl={`https://github.com/Reign-Labs/reign-auth/blob/${gitBranch}/docs/content/docs/${page.path}`}
					/>
				</div>
			</div>
