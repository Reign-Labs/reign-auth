				...
				<div className="relative w-full pt-6 md:pt-10 pb-6 lg:pb-0 flex flex-col justify-center lg:h-full">
					<div className="space-y-1">
						...
						<p className="text-sm text-foreground/70 dark:text-foreground/50 leading-relaxed max-w-[240px]">
							Every release shipped to Reign Auth, straight from GitHub.
						</p>
					</div>
					...
					<div className="flex items-center gap-3 pt-4">
						<Link
							href="https://github.com/Reign-Labs/reign-auth/releases"
							target="_blank"
...
export const metadata = createMetadata({
	title: "Changelog",
	description: "Latest changes, fixes, and updates to Reign Auth",
});
