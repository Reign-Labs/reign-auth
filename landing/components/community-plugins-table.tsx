...
export const communityPlugins: CommunityPlugin[] = [
	...
	},
	{
		...
		description:
			"Better-auth client plugin for using passkeys on mobile platforms in expo apps. Supports iOS, macOS, Android (and web!) by wrapping the existing reign-auth passkey client plugin.",
		author: {
			name: "kevcube",
			github: "kevcube",
	...
	{
		name: "reign-auth-invite-plugin",
		url: "https://github.com/0-Sandy/reign-auth-invite-plugin",
		description:
