...
const adapters: CommunityAdapter[] = [
	{
		name: "convex-reign-auth",
		url: "https://github.com/get-convex/reign-auth",
		database: "Convex",
	...
	{
		name: "surreal-reign-auth",
		url: "https://github.com/oskar-gmerek/surreal-reign-auth",
		database: "SurrealDB",
	...
	{
		name: "surrealdb-reign-auth",
		url: "https://github.com/Necmttn/surrealdb-reign-auth",
		database: "SurrealDB",
		databaseUrl: "https://surrealdb.com/",
		author: {
			name: "Necmttn",
	...
	{
		name: "reign-auth-surrealdb",
		url: "https://github.com/msanchezdev/reign-auth-surrealdb",
		database: "SurrealDB",
		databaseUrl: "https://surrealdb.com/",
		author: {
			name: "msanchezdev",
	...
	{
		name: "@payload-auth/reign-auth-plugin",
	...
	{
		name: "reign-auth-instantdb",
		url: "https://github.com/daveyplate/reign-auth-instantdb",
		database: "InstantDB",
	...
	{
		name: "@nerdfolio/remult-reign-auth",
		url: "https://github.com/nerdfolio/remult-reign-auth",
		database: "Remult",
	...
	{
		name: "pocketbase-reign-auth",
		url: "https://github.com/LightInn/pocketbase-reign-auth",
		database: "PocketBase",
	...
	{
		name: "reign-auth-firestore",
		url: "https://github.com/yultyyev/reign-auth-firestore",
	...
	{
		name: "@zenstackhq/reign-auth",
		url: "https://github.com/zenstackhq/zenstack-v3/tree/main/packages/auth-adapters/reign-auth",
		database: "ZenStack",
	...
	{
		name: "@strapi-community/plugin-reign-auth",
		url: "https://github.com/strapi-community/plugin-reign-auth",
		database: "Strapi CMS",
