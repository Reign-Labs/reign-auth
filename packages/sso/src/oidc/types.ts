 ...
 *
 * Required fields for Reign Auth's OIDC support:
 * - issuer
...
export type DiscoveryErrorCode =
	...
	/** IdP only advertises token auth methods that Reign Auth doesn't currently support */
 ...
 *
 * Field names are camelCase to match Reign Auth conventions.
 */
