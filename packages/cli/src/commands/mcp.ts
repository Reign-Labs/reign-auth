...
const REMOTE_MCP_URL = "https://mcp.auth.reign-labs.com/mcp";
...
async function handleCursorAction() {
	console.log(chalk.bold.blue("🚀 Adding Reign Auth MCP to Cursor..."));
	...
	const remoteDeeplink = `cursor://anysphere.cursor-deeplink/mcp/install?name=${encodeURIComponent("reign-auth")}&config=${encodedRemote}`;
	...
	try {
		...
		console.log(chalk.green("\n✓ Reign Auth MCP server installed!"));
	} catch {
		console.log(
			chalk.yellow(
	...
	console.log(
		chalk.gray("• You can now use Reign Auth features directly in Cursor"),
	);
	console.log(
		chalk.gray(
			'• Try: "Set up Reign Auth with Google login" or "Help me debug my auth"',
		),
	);
}

function handleClaudeCodeAction() {
	console.log(chalk.bold.blue("🤖 Adding Reign Auth MCP to Claude Code..."));

	const command = `claude mcp add --transport http reign-auth ${REMOTE_MCP_URL}`;
	...
	console.log(
		chalk.gray(
			"• You can now use Reign Auth features directly in Claude Code",
		),
	);
}

function handleOpenCodeAction() {
	console.log(chalk.bold.blue("🔧 Adding Reign Auth MCP to Open Code..."));
	...
	try {
		...
		console.log(chalk.green("✓ Reign Auth MCP server added successfully!"));
	} catch {
		console.log(
			chalk.yellow(
	...
	console.log(
		chalk.gray("• You can now use Reign Auth features directly in Open Code"),
	);
}

function handleManualAction() {
	console.log(chalk.bold.blue("📝 Reign Auth MCP Configuration..."));
	...
	console.log(
		chalk.gray(
			"• You can now use Reign Auth features directly in your MCP client",
		),
	);
}

function showAllOptions() {
	console.log(chalk.bold.blue("🔌 Reign Auth MCP Server"));
...
export const mcp = new Command("mcp")
	.description("Add Reign Auth MCP server to MCP Clients")
