 ...
 // Send email with OTP
	...
	passkey: {
		...
		auth: {
			...
			imports: [
				{
					path: "reign-auth/plugins/passkey",
			...
			arguments: [
				{
					...
					defaultValue: "reign-auth.last_used_login_method",
					skip: "prompt",
					argument: {
						index: 0,
	...
	scim: {
		displayName: "SCIM",
		dependencies: ["@reign-auth/scim"],
		auth: {
			function: "scim",
			imports: [
				{
					path: "@reign-auth/scim",
	...
	stripe: {
		displayName: "Stripe",
		dependencies: ["stripe", "@reign-auth/stripe"],
		auth: {
			function: "stripe",
			imports: [
				{
					path: "@reign-auth/stripe",
	...
	i18n: {
		displayName: "I18n",
		dependencies: ["@reign-auth/i18n"],
		auth: {
			function: "i18n",
			imports: [
				{
					path: "@reign-auth/i18n",
