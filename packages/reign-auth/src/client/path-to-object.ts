...
import type { BetterFetchResponse } from "@reign-auth/fetch";
import type { Endpoint, InputContext } from "reign-call";
import type {
	HasRequiredKeys,
	Prettify,
	UnionToIntersection,
...
type ReplaceAuthUserAndSession<
	Data,
	ClientOpts extends ReignAuthClientOptions,
...
export type InferRoute<API, COpts extends ReignAuthClientOptions> =
