...
import { capitalizeFirstLetter } from "@reign-auth/core/utils/string";
import type {
	BetterFetchError,
	BetterFetchResponse,
...
type InferResolvedHooks<O extends ReignAuthClientOptions> = O extends {
...
export function createAuthClient<Option extends ReignAuthClientOptions>(
...
export type AuthClient<Option extends ReignAuthClientOptions> = ReturnType<
