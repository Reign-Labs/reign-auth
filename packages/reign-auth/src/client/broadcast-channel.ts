...
export const kBroadcastChannel = Symbol.for("reign-auth:broadcast-channel");
...
class WindowBroadcastChannel implements BroadcastChannel {
	...
	constructor(name = "reign-auth.message") {
		this.name = name;
	}
...
export function getGlobalBroadcastChannel(name = "reign-auth.message") {
