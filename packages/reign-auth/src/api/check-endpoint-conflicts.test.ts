...
import type { InternalLogger, LogLevel } from "@reign-auth/core/env";
import { createEndpoint } from "reign-call";
...
describe("checkEndpointConflicts", () => {
	...
	it("should not log errors when there are no endpoint conflicts", () => {
		...
		const options: ReignAuthOptions = {
