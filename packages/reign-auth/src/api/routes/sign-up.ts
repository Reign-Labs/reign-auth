...
import { runWithTransaction } from "@reign-auth/core/context";
import { isDevelopment } from "@reign-auth/core/env";
...
export const signUpEmail = <O extends ReignAuthOptions>() =>
	createAuthEndpoint(
		"/sign-up/email",
		{
			method: "POST",
