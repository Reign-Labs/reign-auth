...
import type { InternalLogger } from "@reign-auth/core/env";
...
import {
	...
	ATTR_HTTP_ROUTE,
	withSpan,
} from "@reign-auth/core/instrumentation";
import { normalizePathname } from "@reign-auth/core/utils/url";
import type { Endpoint, Middleware } from "reign-call";
import { createRouter } from "reign-call";
...
export function getEndpoints<Option extends ReignAuthOptions>(
...
export const router = <Option extends ReignAuthOptions>(
	ctx: AuthContext,
	options: Option,
) => {
...
export { APIError } from "@reign-auth/core/error";
