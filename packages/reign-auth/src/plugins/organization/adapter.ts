import type { AuthContext, GenericEndpointContext } from "@reign-auth/core";
import { getCurrentAdapter } from "@reign-auth/core/context";
import type { WhereOperator } from "@reign-auth/core/db/adapter";
	...
	return {
		...
		deleteMember: async ({
			...
			if (!_userId) {
				...
				if (!member) {
					throw new ReignAuthError("Member not found");
				}
