import type { APIError } from "@reign-auth/core/error";
import { memoryAdapter } from "@reign-auth/memory-adapter";
import type { Prettify } from "reign-call";
...
describe("organization", async () => {
	...
	/**
	 * @see https://github.com/Reign-Labs/reign-auth/issues/8385
	 */
...
/**
 * @see https://github.com/Reign-Labs/reign-auth/issues/7822
 */
...
describe("Additional Fields", async () => {
	...
	/**
	 * @see https://github.com/Reign-Labs/reign-auth/issues/7981
	 */
		...
		fetchOptions: {
			onSuccess(context) {
				...
				addedMemberHeaders.set(
					"cookie",
					`reign-auth.session_token=${signedCookie}`,
				);
			},
		},
	});
