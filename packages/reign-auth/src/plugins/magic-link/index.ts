...
export const magicLink = (options: MagicLinkOptions) => {
	...
	return {
		...
		endpoints: {
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/sign-in#api-method-sign-in-magic-link)
			 */
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/magic-link#api-method-magic-link-verify)
			 */
