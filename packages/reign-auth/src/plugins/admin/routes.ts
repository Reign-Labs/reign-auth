...
} from "@reign-auth/core/api";
import type { Session } from "@reign-auth/core/db";
import type { Where } from "@reign-auth/core/db/adapter";
import { whereOperators } from "@reign-auth/core/db/adapter";
import { APIError, BASE_ERROR_CODES } from "@reign-auth/core/error";
 ...
 *
 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/admin#api-method-admin-set-role)
 */
 ...
 *
 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/admin#api-method-admin-create-user)
 */
 ...
 *
 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/admin#api-method-admin-update-user)
 */
 ...
 *
 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/admin#api-method-admin-list-user-sessions)
 */
 ...
 *
 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/admin#api-method-admin-unban-user)
 */
 ...
 *
 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/admin#api-method-admin-ban-user)
 */
 ...
 *
 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/admin#api-method-admin-impersonate-user)
 */
 ...
 *
 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/admin#api-method-admin-stop-impersonating)
 */
 ...
 *
 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/admin#api-method-admin-revoke-user-session)
 */
 ...
 *
 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/admin#api-method-admin-revoke-user-sessions)
 */
 ...
 *
 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/admin#api-method-admin-remove-user)
 */
 ...
 *
 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/admin#api-method-admin-set-user-password)
 */
 ...
 *
 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/admin#api-method-admin-has-permission)
 */
