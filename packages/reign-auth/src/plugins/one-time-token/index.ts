...
export const oneTimeToken = (options?: OneTimeTokenOptions | undefined) => {
	...
	return {
		...
		endpoints: {
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/one-time-token#api-method-one-time-token-generate)
			 */
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/one-time-token#api-method-one-time-token-verify)
			 */
