import type { GenericEndpointContext } from "@reign-auth/core";
import { createAuthEndpoint } from "@reign-auth/core/api";
import { BASE_ERROR_CODES } from "@reign-auth/core/error";
import { deprecate } from "@reign-auth/core/utils/deprecate";
 ...
 *
 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/email-otp#api-method-email-otp-send-verification-otp)
 */
 ...
 *
 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/email-otp#api-method-email-otp-get-verification-otp)
 */
 ...
 *
 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/email-otp#api-method-email-otp-check-verification-otp)
 */
 ...
 *
 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/email-otp#api-method-email-otp-verify-email)
 */
 ...
 *
 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/email-otp#api-method-sign-in-email-otp)
 */
 ...
 *
 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/email-otp#reset-password-with-otp)
 */
 ...
 *
 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/email-otp#api-method-email-otp-reset-password)
 */
 ...
 *
 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/email-otp#change-email-with-otp)
 */
