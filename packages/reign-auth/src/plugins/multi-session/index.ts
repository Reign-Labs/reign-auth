...
export const multiSession = (options?: MultiSessionConfig | undefined) => {
	...
	return {
		...
		endpoints: {
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/multi-session#api-method-multi-session-list-device-sessions)
			 */
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/multi-session#api-method-multi-session-set-active)
			 */
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/multi-session#api-method-multi-session-revoke)
			 */
