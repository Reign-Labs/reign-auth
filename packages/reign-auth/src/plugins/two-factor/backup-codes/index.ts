...
export const backupCode2fa = (opts: BackupCodeOptions) => {
	...
	return {
		...
		endpoints: {
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/2fa#api-method-two-factor-verify-backup-code)
			 */
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/2fa#api-method-two-factor-generate-backup-codes)
			 */
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/2fa#api-method-two-factor-view-backup-codes)
			 */
