import type { Awaitable, GenericEndpointContext } from "@reign-auth/core";
...
export const otp2fa = (options?: OTPOptions | undefined) => {
	...
	return {
		...
		endpoints: {
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/2fa#api-method-two-factor-send-otp)
			 */
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/2fa#api-method-two-factor-verify-otp)
			 */
