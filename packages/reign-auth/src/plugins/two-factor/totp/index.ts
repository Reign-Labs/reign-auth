...
export const totp2fa = (options?: TOTPOptions | undefined) => {
	...
	return {
		...
		endpoints: {
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/2fa#totp)
			 */
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/2fa#getting-totp-uri)
			 */
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/2fa#verifying-totp)
			 */
			verifyTOTP,
		},
