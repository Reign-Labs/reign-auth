...
export const twoFactor = <O extends TwoFactorOptions>(options?: O) => {
	...
	return {
		...
		endpoints: {
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/2fa#api-method-two-factor-enable)
			 */
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/2fa#api-method-two-factor-disable)
			 */
