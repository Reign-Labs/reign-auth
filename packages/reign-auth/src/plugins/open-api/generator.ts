...
export async function generator(ctx: AuthContext, options: ReignAuthOptions) {
	...
	const res = {
		...
		info: {
			title: "Reign Auth",
			description: "API Reference for your Reign Auth Instance",
			version: "1.1.0",
		},
		components: {
			...components,
		...
		tags: [
			{
				name: "Default",
				description:
					"Default endpoints that are included with Reign Auth by default. These endpoints are not part of any plugin.",
			},
		],
		paths,
	};
