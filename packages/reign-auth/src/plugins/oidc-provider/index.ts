...
import { getCurrentAuthContext } from "@reign-auth/core/context";
import { base64 } from "@reign-auth/utils/base64";
import { createHash } from "@reign-auth/utils/hash";
import type { OpenAPIParameter } from "reign-call";
...
export const oidcProvider = (options: OIDCOptions) => {
	...
	return {
		...
		endpoints: {
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/oidc-provider#api-method-oauth2-register)
			 */
