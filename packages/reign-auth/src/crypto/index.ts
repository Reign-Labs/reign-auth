...
import { getWebcryptoSubtle } from "@reign-auth/utils";
...
export const symmetricDecrypt = async ({
	...
	throw new Error(
		"Cannot decrypt legacy bare-hex payload: no legacy secret available. Set REIGN_AUTH_SECRET for backwards compatibility.",
	);
};
