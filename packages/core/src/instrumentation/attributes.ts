...
export const ATTR_OPERATION_ID = "reign_auth.operation_id" as const;

/** Hook type (e.g. before, after, create.before). */
export const ATTR_HOOK_TYPE = "reign_auth.hook.type" as const;

/** Execution context (e.g. user, plugin:id). */
export const ATTR_CONTEXT = "reign_auth.context" as const;
