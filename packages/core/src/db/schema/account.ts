...
import type { ReignAuthOptions } from "../../types/init-options";
import type {
...
/**
 * Account schema type used by reign-auth, note that it's possible that account could have additional fields
 */
export type Account<
	DBOptions extends ReignAuthOptions["account"] = ReignAuthOptions["account"],
