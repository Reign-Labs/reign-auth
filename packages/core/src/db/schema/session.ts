...
/**
 * Session schema type used by reign-auth, note that it's possible that session could have additional fields
 */
export type Session<
	DBOptions extends ReignAuthOptions["session"] = ReignAuthOptions["session"],
