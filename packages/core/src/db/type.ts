...
export type InferDBFieldsFromOptionsInput<
	DBOptions extends
		| ReignAuthOptions["session"]
		| ReignAuthOptions["user"]
		| ReignAuthOptions["verification"]
		| ReignAuthOptions["account"]
		| ReignAuthOptions["rateLimit"],
> = DBOptions extends {
...
export type ReignAuthDBSchema = Record<
	string,
	{
		/**
