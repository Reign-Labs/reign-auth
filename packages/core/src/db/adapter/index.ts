...
import type { ReignAuthDBSchema, DBFieldAttribute } from "../type";
...
export type DBAdapter<Options extends ReignAuthOptions = ReignAuthOptions> = {
	id: string;
...
export interface DBAdapterInstance<
	Options extends ReignAuthOptions = ReignAuthOptions,
> {
	(options: ReignAuthOptions): DBAdapter<Options>;
}
