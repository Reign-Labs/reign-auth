...
import type { ReignAuthPluginDBSchema } from "../db";
...
export type ReignAuthPluginErrorCodePart = {
	/**
...
export type ReignAuthPlugin = ReignAuthPluginErrorCodePart & {
	id: LiteralString;
	/**
	 ...
	 * ```
	 */
	schema?: ReignAuthPluginDBSchema | undefined;
	/**
