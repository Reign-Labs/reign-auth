...
/**
 * Common environment variables used in Reign Auth
 */
export const ENV = Object.freeze({
	get REIGN_AUTH_SECRET() {
		return getEnvVar("REIGN_AUTH_SECRET");
	},
	get AUTH_SECRET() {
		return getEnvVar("AUTH_SECRET");
	},
	get REIGN_AUTH_TELEMETRY() {
		return getEnvVar("REIGN_AUTH_TELEMETRY");
	},
	get REIGN_AUTH_TELEMETRY_ID() {
		return getEnvVar("REIGN_AUTH_TELEMETRY_ID");
	},
	get NODE_ENV() {
	...
	get REIGN_AUTH_TELEMETRY_ENDPOINT(): string | undefined {
		return getEnvVar(
			"REIGN_AUTH_TELEMETRY_ENDPOINT",
			import.meta.env.REIGN_AUTH_TELEMETRY_ENDPOINT,
		);
	},
});
