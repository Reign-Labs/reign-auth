...
```bash
pnpm add @reign-auth/utils
```

## Utilities at a Glance

utilities provided by `@reign-auth/utils`:
...
```ts
import { rsa } from "@reign-auth/utils/rsa";
...
```ts
import { ecdsa } from "@reign-auth/utils/ecdsa";
...
```ts
import { createOTP } from "@reign-auth/utils";
...
```ts
import { hex } from "@reign-auth/utils/hex";
...
```ts
import { binary } from "@reign-auth/util/binary"
