import type { ReignAuthPlugin, HookEndpointContext } from "@reign-auth/core";
...
import { ReignAuthError } from "reign-auth";
import { APIError } from "reign-auth/api";
...
export function apiKey(
	...
	return {
		...
		endpoints: {
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/api-key#api-method-api-key-create)
			 */
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/api-key#api-method-api-key-verify)
			 */
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/api-key#api-method-api-key-get)
			 */
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/api-key#api-method-api-key-update)
			 */
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/api-key#api-method-api-key-delete)
			 */
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/api-key#api-method-api-key-list)
			 */
			 ...
			 *
			 * @see [Read our docs to learn more.](https://auth.reign-labs.com/docs/plugins/api-key#api-method-api-key-delete-all-expired-api-keys)
			 */
