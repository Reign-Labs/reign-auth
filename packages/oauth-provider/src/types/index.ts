import type { LiteralString } from "@reign-auth/core";
import type { InferOptionSchema, Session, User } from "reign-auth/types";
...
export interface OAuthAuthorizationQuery {
	 ...
	 *
	 * Note: Reign Auth stores the state in a database instead of a cookie. - This is to minimize
	 ...
	 * designation).
	 *
	 * Reign Auth does not support this parameter yet. It'll not throw an error if it's provided,
	 *
