import { createClientCredentialsTokenRequest } from "@reign-auth/core/oauth2";
import { createAuthClient } from "reign-auth/client";
import { jwtClient } from "reign-auth/client/plugins";
import { generateRandomString } from "reign-auth/crypto";
import type { ProviderOptions } from "reign-auth/oauth2";
import {
	createAuthorizationCodeRequest,
	createAuthorizationURL,
	createRefreshAccessTokenRequest,
} from "reign-auth/oauth2";
...
describe("oauth token - client secret validation", async () => {
	...
	/**
	 * @see https://github.com/Reign-Labs/reign-auth/issues/8016
	 */
