import { defineRequestState } from "@reign-auth/core/context";
...
import type { ReignAuthPlugin } from "reign-auth/types";
...
/**
 * oAuth 2.1 provider plugin for Reign Auth.
 *
 * @see https://auth.reign-labs.com/docs/plugins/oauth-provider
