...
Reign Auth is a comprehensive, framework-agnostic authentication
...
* `packages/reign-auth` - Main authentication library
...
* If a test is to prevent regression of a specific numbered GitHub issue,
  ...
  ```typescript
  /**
   * @see https://github.com/Reign-Labs/reign-auth/issues/{issue_number}
   */
